    ...
    <section className="py-14 md:py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-0">
        <div className="flex items-center gap-3 mb-1.5">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">Quick Actions</h2>
        </div>
        <p className="text-zinc-400 text-sm mb-8 pl-9">Everything you need, in one place.</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {actions.map(({ icon: Icon, title, description, cta, to }) => (
            <Link
              key={title}
              to={to}
              className="group bg-zinc-950 border border-zinc-800 rounded-2xl p-6 hover:border-amber-400/40 transition-colors flex flex-col"
            >
              ...
              <span className="mt-5 inline-flex items-center gap-1.5 text-xs font-bold text-amber-400 group-hover:gap-2.5 transition-all">
